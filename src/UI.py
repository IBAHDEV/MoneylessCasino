...
def appMain():
    ...
    def show_minigames():
        ...
        selection_title = ctk.CTkLabel(
            master=minigame_selection_frame, 
            text="Select your Minigame", 
            font=("Roboto", 28, "bold")
            )
        ...
        blackjack_image_ctk = ctk.CTkImage(
            light_image=blackjack_image_raw, 
            dark_image=blackjack_image_raw, 
            size=(210,210)
            )
        ...
        blackjack_label = ctk.CTkLabel(
            master=blackjack_tile, 
            text="BlackJack", 
            font=("Roboto",22)
            )
        ...
        back_button = ctk.CTkButton(
            ...
            command=lambda: return_to_menu(minigame_selection_frame)
            )
